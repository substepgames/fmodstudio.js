...
Also defines the number of channels in the unit that a read callback will process, and the output signal of the unit.
    ...
    export type CHANNELCONTROL_CALLBACK = (channel, controltype, callbacktype, commanddata1, commanddata2) => void
    ...
    export type CODEC_METADATA_CALLBACK = (codec_state, type, name, data, datalen, datatype, unique) => void
    ...
    export type DEBUG_CALLBACK = (flags: DEBUG_FLAGS, file: string, line: number, func: string, message: string) => void
