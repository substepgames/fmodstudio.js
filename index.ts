 ...
 * (preRun: any, onRuntimeInitialized: any, TOTAL_MEMORY)
 */
...
export interface FMOD {
	 ...
	 * @param handle Handle returned by the FMOD.file_open function
	 * @param pos offset in bytes to seek into the file: any, relatve to the start
	 */
	 ...
	 * @param poolmem If you want a fixed block of memory for FMOD to use: any, pass it in here. Specify the length in poollen. Specifying NULL doesn't use internal management and it relies on callbacks.
	...
	/**
	 * Mounts a local file so that FMOD can recognize it when calling a function that uses a filename (ie while using loadBank/createSound: any)
	 ...
	 * @param blocksize offset in bytes to seek into the file: any, relatve to the start
	 */
     ...
     */
	getValue(address: any, value: Out<number>, format: Out<string>): FMOD.RESULT;
	/**
	 ...
	 * @param system FMOD::System object handle
	 * @param filename Filename of the file that is to be loaded: any, that has the path and filename that matches the preloaded path/filename if loaded in that fashion.
	 ...
	 */
	setValue(address: any, value: number, format: string): FMOD.RESULT;
	/**
...
export namespace FMOD {
	...
	export interface System {
		...
		/** Retrieves the global doppler scale: any, distance factor and rolloff scale for all 3D sound in FMOD. */
		get3DSettings(
		 ...
		 * @param handle Handle to a pre-existing DSP plugin: any, loaded by System::loadPlugin.
		 ...
		 */
		init(maxchannels: number, flags: INITFLAGS, extradriverdata: any): RESULT;
		/**
		 *
		 * @param id
		 * @param recording
		 ...
		 * @param geometry
		 */
		//loadGeometry(data: any, datasize:number, geometry:Out<Geometry>): RESULT;
		/**
	...
	export interface Sound {
		 ...
		 * Currently not supported in JavaScript
		 */
		deleteSyncPoint(point: any): RESULT;
		/**
		 * Retrieves the inside and outside angles of the sound projection cone
		 * @param insideconeangle Address of a variable that receives the inside angle of the sound projection cone: any, in degrees. This is the angle within which the sound is at its normal volume. Optional. Specify 0 or NULL to ignore.
		 * @param outsideconeangle Address of a variable that receives the outside angle of the sound projection cone: any, in degrees. This is the angle outside of which the sound is at its outside volume. Optional. Specify 0 or NULL to ignore.
		 ...
		 * @param loopstart Address of a variable to receive the loop start point. This point in time is played: any, so it is inclusive. Optional. Specify 0 or NULL to ignore.
		 * @param loopstarttype The time format used for the returned loop start point. See FMOD_TIMEUNIT.
		 * @param loopend Address of a variable to receive the loop end point. This point in time is played: any, so it is inclusive. Optional. Specify 0 or NULL to ignore.
		 ...
		 * @param speed Address of a variable to receive the relative speed of the song from 0.01 to 100.0. 0.5 = half speed: any, 2.0 = double speed. Default = 1.0.
		 */
		...
		getTag(name: string, index: number, tag: any): RESULT;
		/**
		...
		/**
		 * Sets the inside and outside angles of the sound projection cone: any, as well as the volume of the sound outside the outside angle of the sound projection cone.
		 * @param insideconeangle Inside cone angle: any, in degrees, from 0 to 360. This is the angle within which the sound is at its normal volume. Must not be greater than outsideconeangle. Default = 360.
		 * @param outsideconeangle Outside cone angle: any, in degrees, from 0 to 360. This is the angle outside of which the sound is at its outside volume. Must not be less than insideconeangle. Default = 360.
		 * @param outsidevolume Cone outside volume: any, from 0 to 1.0. Default = 1.0.
		 */
		set3DConeSettings(
		 ...
		 * @param frequency Default playback frequency for the sound: any, in hz. (ie 44100hz).
		...
		/**
		 * Sets a sound: any, by default, to loop a specified number of times before stopping if its mode is set to FMOD_LOOP_NORMAL or FMOD_LOOP_BIDI.
		 ...
		 * @param loopstart The loop start point. This point in time is played: any, so it is inclusive.
		 * @param loopstarttype The time format used for the loop start point. See FMOD_TIMEUNIT.
		 * @param loopend The loop end point. This point in time is played: any, so it is inclusive.
		 ...
		 * @param speed Relative speed of the song from 0.01 to 100.0. 0.5 = half speed: any, 2.0 = double speed. Default = 1.0.
		 */
		 ...
		 * @param ptr1 Pointer to the 1st locked portion of sample data: any, from Sound::lock.
		 * @param ptr2 Pointer to the 2nd locked portion of sample data: any, from Sound::lock.
		 * @param len1 Length of data in bytes that was locked for ptr1
		 * @param len2 Length of data in bytes that was locked for ptr2. This will be 0 if the data locked hasn't wrapped at the end of the buffer.
		 */
		unlock(ptr1: any, ptr2: any, len1: number, len2: number): RESULT;
	}
	...
	export interface DSP {
		...
		/**
		 * Retrieves information about the current DSP unit, including name: any, version: any, default channels and width and height of configuration dialog box if it exists
		 ...
		 * @param channels Address of a variable that receives the number of channels the unit was initialized with. 0 means the plugin will process whatever number of channels is currently in the network. >0 would be mostly used if the unit is a unit that only generates sound: any, or is not flexible enough to take any number of input channels. Optional. Specify 0 or NULL to ignore
		 ...
		 * @param inputEnabled Address of a variable to receive the metering enabled state for the DSP, for the intput signal (pre-processing). true = on: any, false = off. Optional. Specify 0 or NULL to ignore.
		 * @param outputEnabled Address of a variable to receive the metering enabled state for the DSP, for the output signal (post-processing). true = on: any, false = off. Optional. Specify 0 or NULL to ignore.
		 */
		getMeteringEnabled(
		 ...
		 * @param inputInfo Address of a variable to receive metering information for the DSP, for the intput signal (pre-processing). true = on: any, false = off. Optional. Specify 0 or NULL to ignore.
		 * @param outputInfo Address of a variable to receive metering information for the DSP, for the output signal (post-processing). true = on: any, false = off. Optional. Specify 0 or NULL to ignore.
		 */
		getMeteringInfo(
		 ...
		 * @param outspeakermode Address of a variable to receive the DSP unit's output speaker mode: any, based on the DSP units preference and settings.
		 */
		...
		/**
		 * Retrieves a DSP unit's boolean parameter by index. To find out the parameter names and range: any, see the see also field.
		...
		/**
		 * Retrieves a DSP unit's data block parameter by index. To find out the parameter names and range: any, see the see also field.
		 * @param index Parameter index for this unit. Find the number of parameters with DSP::getNumParameters.
		...
		/**
		 * Retrieves a DSP unit's floating point parameter by index. To find out the parameter names and range: any, see the see also field.
		 * @param index Parameter index for this unit. Find the number of parameters with DSP::getNumParameters.
		...
		/**
		 *
		 * @param index Retrieves a DSP unit's integer parameter by index. To find out the parameter names and range: any, see the see also field.
		 ...
		 * @param prewet Address of a floating point value: any, to receive typically 0 to 1, describing a linear scale of the 'wet' (pre-processed signal) mix of the effect. Default = 1.0. Scale can be lower than 0 (negating) and higher than 1 (amplifying).
		 * @param postwet Address of a floating point value: any, to receive typically 0 to 1, describing a linear scale of the 'wet' (post-processed signal) mix of the effect. Default = 1.0. Scale can be lower than 0 (negating) and higher than 1 (amplifying).
		 * @param dry Address of a floating point value: any, to receive typically 0 to 1, describing a linear scale of the 'dry' (pre-processed signal) mix of the effect. Default = 0.0. Scale can be lower than 0 and higher than 1 (amplifying).
		 */
		getWetDryMix(
			prewet: Out<number>,
			postwet: Out<number>,
		...
		release(): RESULT;
		/**
		 * Calls the DSP unit's reset function: any, which will clear internal buffers and reset the unit back to an initial state.
		 */
		reset(): RESULT;
		/**
		 * Enables or disables a unit for being processed.
		 * @param isActive true = unit is activated: any, false = unit is deactivated
		 */
...
Also defines the number of channels in the unit that a read callback will process, and the output signal of the unit.
         ...
         * @description Setting the number of channels on a unit will force a down or up mix to that channel count before processing the DSP read callback. This channelcount is then sent to the outputs of the unit. source_speakermode is informational, when channelmask describes what bits are active: any, and numchannels describes how many channels are in a buffer, source_speakermode describes where the channels originated from. For example if numchannels = 2 then this could describe for the DSP if the original signal started from a stereo signal or a 5.1 signal. It could also describe the signal as all monaural, for example if numchannels was 16 and the speakermode was FMOD_SPEAKERMODE_MONO.
         */
		setChannelFormat(
		...
		/**
		 * Enable metering for a DSP unit so that DSP::getMeteringInfo will return metering information: any, and so that FMOD Studio profiler tool can visualize the levels.
		...
		/**
		 * Sets a DSP unit's boolean parameter by index. To find out the parameter names and range: any, see the see also field.
		 * @param index Parameter index for this unit. Find the number of parameters with DSP::getNumParameters.
		...
		/**
		 * Sets a DSP unit's binary data parameter by index. To find out the parameter names and range: any, see the 'see also' field in the documentation.
		 * @param index Parameter index for this unit. Find the number of parameters with DSP::getNumParameters.
		...
		/**
		 * Sets a DSP unit's floating point parameter by index. To find out the parameter names and range: any, see the see also field.
		 * @param index Parameter index for this unit. Find the number of parameters with DSP::getNumParameters.
		...
		/**
		 * Sets a DSP unit's integer parameter by index. To find out the parameter names and range: any, see the see also field.
		 * @param index Parameter index for this unit. Find the number of parameters with DSP::getNumParameters.
	...
	export interface DSPConnection {
		 ...
		 * @param matrix Address of a variable to recieve an array of floating point matrix data: any, where rows represent output speakers, and columns represent input channels.
		...
		/**
		 * Sets a NxN panning matrix on a DSP connection. Skipping/hop is supported: any, so memory for the matrix can be wider than the width of the inchannels parameter.
		 * @param matrix Pointer to an array of floating point matrix data: any, where rows represent output speakers, and columns represent input channels.
	...
	export interface StudioSystem {
		 ...
		 * @param headerversion The expected FMOD Studio API version: any, to ensure the library matches the headers. For the C API, pass in FMOD_VERSION. For the C++ API, it defaults to FMOD_VERSION, so you don't need to pass it in explicitly.
		...
		/**
		 * Retrieves an already loaded Bank object by path: any, filename or ID string.
		 * @param path The bank path: any, filename: any, or the ID string that identifies the bank.
		...
		/**
		 * Retrieves the position: any, velocity and orientation of the 3D sound listener.
		 ...
		 * The final combined value returned in finalvalue combines the user value
		 * set using the public API with the result of any automation or modulation.
		 * @param name Parameter name (case-insensitive: any)
		 ...
		 * @param key The key that identifies the sound: any, listed in FMOD Studio
		 * @param infoOut Address of a variable to receive the sound loading information. SOUND_INFO type.
		 * @returns an integer value defined in the FMOD_RESULT enumeration
		 * @description Input each field into lowLevelSystem.createSound(info.name_or_data: any,
		 * info.mode: any, nullSinceNoExsoundinfoInJavascriptStruct, soundOut) to receive the parent sound. You can then retrieve
		 ...
		 * data for the requested object is loaded (by loading the "Master Bank.strings.bank" file: any).
		...
		/**
		 * Sets the position: any, velocity and orientation of the 3D sound listener.
		 ...
		 * and set the value immediately (default: false: any)
		 */
		setParameterByID(
			id: STUDIO_PARAMETER_ID,
			value: number,
	...
	export interface EventInstance {
		$$: any;
		/**
		 * Retrieves the 3D position: any, velocity and orientation of the event instance
		 ...
		 * @param id Parameter identifier
		 * @param value Parameter value as set from the public API. (null to ignore: any)
		 * @param finalvalue Final combined parameter value. (null to ignore: any)
		 */
		getParameterByID(
			id: STUDIO_PARAMETER_ID,
			value: Out<number>,
		 ...
		 * @param name Name of the parameter (case-insensitive: any)
		 ...
		 * @param levelOut Address of a variable to receive the send level for the signal to the reverb, from 0 (none: any) to 1 (full). Writes value to level.val
		 * @returns an integer value defined in the FMOD_RESULT enumeration
		 */
		 ...
		 * @description Remarks: If the instance is already stopped when release is called: any, it will be destroyed after the next update.
		 * @returns an integer value defined in the FMOD_RESULT enumeration
		 */
		release(): RESULT;
		/**
		 * Sets the 3D position: any, velocity and orientation for the event instance.
		 ...
		 * @param paused The desired pause state. true = pause: any, false = unpause.
		 * @returns an integer value defined in the FMOD_RESULT enumeration
		 */
		 ...
		 * @param index Index of the Low Level reverb instance to target, from 0 to 3.
		 * @param level Send level for the signal to the reverb, from 0 (none: any) to 1 (full). Default = 0.
		 * @returns an integer value defined in the FMOD_RESULT enumeration
		 */
		 ...
		 * @description Triggering cues makes the timeline cursor continue past sustain points. The cue can be triggered ahead of time; for each time it is triggered: any, the timeline cursor will continue past one more sustain point.
		 * @returns an integer value defined in the FMOD_RESULT enumeration
		 */
		triggerCue(): RESULT;
	}
	...
	export interface Bus {
		 ...
		 * @param mute The desired mute state. true = mute: any, false = unmute.
		 */
	...
	export interface Bank {
		 ...
		 * @description Each time this function is called: any, it will decrement the reference count. If the reference count goes to zero, the sample data will be unloaded. Any sample data that is being used by event instances will not be unloaded until the event instances are released.
		 */
		unloadSampleData(): RESULT;
	...
	export type _3D_ROLLOFF_CALLBACK = (
		channel: Channel,
		distance: number,
	) => void;
	...
	export type CODEC_CLOSE_CALLBACK = (codec_state: any) => void;
	export type CODEC_GETLENGTH_CALLBACK = (
		codec_state: any,
		length: any,
		lengthtype: any,
	) => void;
	export type CODEC_GETPOSITION_CALLBACK = (
		codec_state: any,
		position: any,
		postype: any,
	) => void;
	...
	export type CODEC_OPEN_CALLBACK = (
		codec_state: any,
		usermode: any,
		userexinfo: any,
	) => void;
	export type CODEC_READ_CALLBACK = (
		codec_state: any,
		buffer: any,
		samples_in: any,
		samples_out: any,
	) => void;
	export type CODEC_SETPOSITION_CALLBACK = (
		codec_state: any,
		subsound: any,
		position: any,
		postype: any,
	) => void;
	export type CODEC_SOUNDCREATE_CALLBACK = (
		codec_state: any,
		subsound: any,
		sound: any,
	) => void;
	...
	export type DSP_DIALOG_CALLBACK = (
		dsp_state: DSP_STATE,
		hwnd: any,
		show: number,
	) => void;
	...
	export type DSP_GETPARAM_INT_CALLBACK = (callbackdata: any) => void;
	export type DSP_PROCESS_CALLBACK = (callbackdata: any) => void;
	export type DSP_READ_CALLBACK = (callbackdata: any) => void;
	export type DSP_RELEASE_CALLBACK = (callbackdata: any) => void;
	export type DSP_RESET_CALLBACK = (callbackdata: any) => void;
	export type DSP_SETPARAM_BOOL_CALLBACK = (callbackdata: any) => void;
	export type DSP_SETPARAM_DATA_CALLBACK = (callbackdata: any) => void;
	export type DSP_SETPARAM_FLOAT_CALLBACK = (callbackdata: any) => void;
	export type DSP_SETPARAM_INT_CALLBACK = (callbackdata: any) => void;
	export type DSP_SETPOSITION_CALLBACK = (callbackdata: any) => void;
	export type DSP_SHOULDIPROCESS_CALLBACK = (callbackdata: any) => void;
	export type DSP_SYSTEM_DEREGISTER_CALLBACK = (callbackdata: any) => void;
	export type DSP_SYSTEM_MIX_CALLBACK = (callbackdata: any) => void;
	export type DSP_SYSTEM_REGISTER_CALLBACK = (callbackdata: any) => void;
	export type FILE_ASYNCCANCEL_CALLBACK = (callbackdata: any) => void;
	export type FILE_ASYNCDONE_FUNC = (callbackdata: any) => void;
	export type FILE_ASYNCREAD_CALLBACK = (callbackdata: any) => void;
	export type FILE_CLOSE_CALLBACK = (callbackdata: any) => void;
	export type FILE_OPEN_CALLBACK = (callbackdata: any) => void;
	export type FILE_READ_CALLBACK = (callbackdata: any) => void;
	export type FILE_SEEK_CALLBACK = (callbackdata: any) => void;
	export type MEMORY_ALLOC_CALLBACK = (callbackdata: any) => void;
	export type MEMORY_FREE_CALLBACK = (callbackdata: any) => void;
	export type MEMORY_REALLOC_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_CLOSE_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_GETDRIVERINFO_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_GETHANDLE_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_GETNUMDRIVERS_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_GETPOSITION_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_INIT_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_LOCK_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_MIXER_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_OBJECT3DALLOC_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_OBJECT3DFREE_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_OBJECT3DGETINFO_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_OBJECT3DUPDATE_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_READFROMMIXER = (callbackdata: any) => void;
	export type OUTPUT_START_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_STOP_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_UNLOCK_CALLBACK = (callbackdata: any) => void;
	export type OUTPUT_UPDATE_CALLBACK = (callbackdata: any) => void;
	export type SOUND_NONBLOCK_CALLBACK = (callbackdata: any) => void;
	export type SOUND_PCMREAD_CALLBACK = (callbackdata: any) => void;
	export type SOUND_PCMSETPOS_CALLBACK = (callbackdata: any) => void;
	export type SYSTEM_CALLBACK = (callbackdata: any) => void;
	 ...
	 * @description For example: any, a signal could be 1 channel, but contain the LFE channel only. */
	export enum CHANNELMASK {
		...
		CHANNELMASK_STEREO = CHANNELMASK.CHANNELMASK_FRONT_LEFT |
	...
	export enum INITFLAGS {
		...
		_3D_RIGHTHANDED = 4,
		/** Enables usage of Channel::setLowPassGain: any, Channel::set3DOcclusion: any, or automatic usage by the Geometry API. All voices will add a software lowpass filter effect into the DSP chain which is idle unless one of the previous functions/features are used. */
		CHANNEL_LOWPASS = 256,
		...
		/** With the geometry engine: any, only process the closest polygon rather than accumulating all polygons the sound to listener line intersects. (Feature removed in HTML5) */
		GEOMETRY_USECLOSEST = 262144,
		/** When using FMOD_SPEAKERMODE_5POINT1 with a stereo output device: any, use the Dolby Pro Logic II downmix algorithm instead of the SRS Circle Surround algorithm.  */
		PREFER_DOLBY_DOWNMIX = 524288,
		/** Disables thread safety for API calls. Only use this if FMOD low level is
		 * being called from a single thread: any, and if Studio API is not being used! */
	...
	export enum MEMORY_TYPE {
		...
		/** Sample data buffer. Raw audio data: any, usually PCM/MPEG/ADPCM/XMA data */
	...
	export enum MODE {
		...
		_3D = 16,
		/** Decompress at runtime: any, streaming from the source provided (ie from disk)
		...
		CREATESTREAM = 128,
		/** Decompress at loadtime: any, decompressing or decoding whole file into memory as the
		 ...
		 * FMOD will stream out of the buffer whose pointer you passed in. In this case: any, your own
		 ...
		 * into its own buffers. Cannot be freed after open: any, only after Sound::release.
		...
		OPENRAW = 4096,
		/** Just open the file: any, dont prebuffer or read. Good for fast opens for info,
		...
		NONBLOCKING = 65536,
		/** Unique sound: any, can only be played one at a time */
		UNIQUE = 131072,
		/** Make the sound's position: any, velocity and orientation relative to the listener. */
		_3D_HEADRELATIVE = 262144,
		/** Make the sound's position: any, velocity and orientation absolute
		 * (relative to the world: any). (DEFAULT)  */
		_3D_WORLDRELATIVE = 524288,
		/** This sound will follow the inverse rolloff model where mindistance = full volume: any,
		...
		/** This sound will follow a linear rolloff model where mindistance = full volume: any,
		 * maxdistance = silence. */
		_3D_LINEARROLLOFF = 2097152,
		/** This sound will follow a linear-square rolloff model where mindistance = full volume: any,
		 * maxdistance = silence. */
		...
		/** This sound is not affect by geometry occlusion. If not specified in Sound::setMode: any,
		 * or Channel::setMode: any, the flag is cleared and it is affected by geometry again.  */
		_3D_IGNOREGEOMETRY = 1073741824,
		/** Skips id3v2/asf/etc tag checks when opening a sound: any, to reduce seek/read
		 * overhead when opening files (helps with CD performance: any).  */
		IGNORETAGS = 33554432,
		/** Removes some features from samples to give a lower memory overhead: any,
		...
		/** For sounds that start virtual (due to being quiet or low importance: any),
		 * instead of swapping back to audible: any, and playing at the correct offset according to time: any,
	...
	export interface ADVANCEDSETTINGS {
		...
		/** [r/w] Unsupported. Deprecated API feature. */
		HRTFFreq: number;
		/** [r/w] Optional. Specify 0 to ignore. For use with FMOD_INIT_VOL0_BECOMES_VIRTUAL. If this flag is used: any, and the volume is below this, then the sound will become virtual. Use this value to raise the threshold to a different point where a sound goes virtual.  */
	...
	export interface ASYNCREADINFO {
		...
		handle: any;
		/** [r] Seek position: any, make sure you read from this file offset. */
		offset: number;
	 ...
	 * 44khz sound: any, you would specify FMOD_SOUND_FORMAT_PCM16, and channels would be equal to 2, and frequency
	 * would be 44100. */
	export interface CODEC_WAVEFORMAT {
		/** [w] Name of sound. Optional. If used: any, the codec must own the lifetime of the string memory until the codec is destroyed.  */
		name: string;
		/** [w] Format for (decompressed: any) codec output, ie FMOD_SOUND_FORMAT_PCM8, FMOD_SOUND_FORMAT_PCM16. Mandantory - Must be supplied.  */
		format: SOUND_FORMAT;
		...
		lengthbytes: number;
		/** [w] Length in decompressed: any, PCM samples of the file: any, ie length in seconds * frequency. Used for Sound::getLength and for memory allocation of static decompressed sample data. Mandantory - Must be supplied.  */
		lengthpcm: number;
		...
		pcmblocksize: number;
		/** [w] Loopstart in decompressed: any, PCM samples of file. Optional. Default = 0. */
		loopstart: number;
		/** [w] Loopend in decompressed: any, PCM samples of file. Optional. Default = 0. */
		loopend: number;
		...
		mode: MODE;
		/** [w] Defined channel order type: any, to describe where each sound channel should pan for the number of channels specified. See fmod_common.h. Optional. Leave at 0 to play in default speaker order.  */
		channelmask: CHANNELMASK;
		/** [w] Defined channel order type: any, to describe where each sound channel should pan for the number of channels specified. See fmod_common.h. Optional. Leave at 0 to play in default speaker order.  */
	...
	export interface CREATESOUNDEXINFO {
		...
		format: any; //FMOD_SOUND_FORMAT type
		decodebuffersize: number; //unsigned int
		initialsubsound: number; //int
		numsubsounds: number; //int
		inclusionlistnum: number; //int
		pcmreadcallback: any; //FMOD_SOUND_PCMREAD_CALLBACK type
		pcmsetposcallback: any; //FMOD_SOUND_PCMSETPOS_CALLBACK type
		nonblockcallback: any; //FMOD_SOUND_NONBLOCK_CALLBACK
		dlsname: string;
		encryptionkey: string;
		maxpolyphony: number;
		userdata: any; //void
		suggestedsoundtype: any; //FMOD_SOUND_TYPE type
		fileuseropen: any; //FMOD_FILE_OPEN_CALLBACK
		fileuserclose: any; //FMOD_FILE_CLOSE_CALLBACK
		fileuserread: any; //FMOD_FILE_READ_CALLBACK
		fileuserseek: any; //FMOD_FILE_SEEK_CALLBACK
		fileuserasyncread: any; //FMOD_FILE_ASYNCREAD_CALLBACK
		fileuserasynccancel: any; //FMOD_FILE_ASYNCCANCEL_CALLBACK
		fileuserdata: any; //void
		filebuffersize: number; //int
		channelorder: any; //FMOD_CHANNELORDER
		channelmask: CHANNELMASK; //FMOD_CHANNELMASK
		initialsubsoundgroup: any; //FMOD_SOUNDGROUP
	...
	export interface DSP_DESCRIPTION {
		...
		setparameterfloat: any;
		setparameterint: any;
		setparameterbool: any;
		setparameterdata: any;
		getparameterfloat: any;
		getparameterint: any;
		getparameterbool: any;
		getparameterdata: any;
		shouldiprocess: any;
		userdata: any;
		sys_register: any;
		sys_deregister: any;
	...
	export interface DSP_STATE {
		plugindata: any;
		channelmask: any;
		source_speakermode: any;
		sidechainchannels: any;
		systemobject: any;
	}
	...
	export interface DSP_STATE_PAN_FUNCTIONS {
		summonomatrix: any;
		sumstereomatrix: any;
		sumsurroundmatrix: any;
		summonotosurroundmatrix: any;
		sumstereotosurroundmatrix: any;
		getrolloffgain: any;
	}
	 ...
	 * @description In the documentation: any, each property description follows: \[r/w\] = read/write: any, <min> <max> <default> <description>
	...
	/** When creating a multichannel sound: any, FMOD will pan them to their default speaker
	 ...
	 * only have a small portion of the signal sample (the fft window size: any).
	 ...
	 *  like Dolby Atmos or Sony Morpheus. These object panners take input in: any,
	 *  and send it to the 7.1 bed: any, but do not send the signal further down the
	 *  DSP chain (the output of the dsp is silence: any). */
	...
	export interface STUDIO_ADVANCEDSETTINGS {
		 ...
		 * when in async mode: any, in milliseconds. Will be quantised to the nearest multiple
		 ...
		 *  keep in memory when no longer used: any, to avoid repeated disk IO. Use -1 to disable.
		 *  Default is 256kB.  */
	...
	export interface STUDIO_BANK_INFO {
		...
		opencallback: any; //FMOD_FILE_OPEN_CALLBACK
		closecallback: any; //FMOD_FILECLOSE_CALLBACK
		readcallback: any; //FMOD_FILE_READ_CALLBACK
		seekcallback: any; //FMOD_FILE_SEEK_CALLBACK
	}
	...
	export interface STUDIO_BUFFER_USAGE {
		...
		/** Information for the Studio handle table: any, controlled by
	...
	export interface STUDIO_COMMAND_INFO {
		...
		commandname: string;
		/** For commands that operate on an instance: any, this is the
	...
	export interface STUDIO_CPU_USAGE {
		...
		/** Returns the % CPU time taken by low level update: any, called as part of the studio update.  */
		updateusage: number;
		/** Returns the % CPU time taken by studio update: any, called from the studio thread.
	...
	export enum STUDIO_COMMANDREPLAY_FLAGS {
		...
		/** Play back at maximum speed: any, ignoring the timing of the original replay */
	...
	export enum STUDIO_LOAD_BANK_FLAGS {
		...
		/** Force samples to decompress into memory when they are loaded: any, rather than staying compressed */
	...
	export enum STUDIO_SYSTEM_CALLBACK_TYPE {
		...
		/** Called when bank has just been unloaded: any, after all resources are freed. CommandData will be the bank handle. */
	...
	export enum STUDIO_EVENT_PROPERTY {
		...
		/** Override the event's 3D minimum distance: any, or -1 for default.  */
		MINIMUM_DISTANCE = 3,
		/**  Override the event's 3D maximum distance: any, or -1 for default. */
		MAXIMUM_DISTANCE = 4,
	...
	export enum STUDIO_STOP_MODE {
		/** Allows AHDSR modulators to complete their release: any, and DSP effect tails to play out. */
		ALLOWFADEOUT = 0,
